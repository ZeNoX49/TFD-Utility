...
public class ControllerReacteurCard {
    ...
    private void initialize() {
        mapTextField.put("Eléctrique Dimmension", imgLink_Electrique_Dimension);
        ...
        mapTextField.put("Feu Dimmension", imgLink_Feu_Dimension);
        ...
        mapTextField.put("Neutre Dimmension", imgLink_Neutre_Dimension);
        ...
        mapTextField.put("Poison Dimmension", imgLink_Poison_Dimension);
        ...
        mapImageView.put("Eléctrique Dimmension", img_Electrique_Dimension);
        ...
        mapImageView.put("Feu Dimmension", img_Feu_Dimension);
        ...
        mapImageView.put("Neutre Dimmension", img_Neutre_Dimension);
        ...
        mapImageView.put("Poison Dimmension", img_Poison_Dimension);
